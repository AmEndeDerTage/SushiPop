...
namespace _20241CBE12B_G2.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        // GET: Categorias/CategoryDetails/nombre
        public async Task<IActionResult> CategoryDetails(string? nombre)
        {
            ...
            var categoria = await _context.Categoria.Include(c => c.Productos).Where(c => c.Nombre.Equals(nombre)).FirstOrDefaultAsync();
